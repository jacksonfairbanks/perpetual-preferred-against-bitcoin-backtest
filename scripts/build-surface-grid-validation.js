 ...
 * manifest. The manifest is read, not modified (see the phase_2 schema
 * stability note below). Does not touch surface_grid.csv, the surface itself,
 * or any of the phase_2.sha256 entries. Integrity of the CSV written here is
 * enforced by verify.sh.
 *
 * Reproduce
