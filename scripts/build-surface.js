 ...
 * ----------------------
 *   Fed 2022 sits at |delta_bcr| = 0.50 exactly under this script's
 *   per-regime anchoring, i.e. on the gate limit. Mt. Gox 2014 reaches
 *   |delta_bcr| = 0.50 under the grid anchor in
 *   build-surface-grid-validation.js. Passing is passing, but there is
 *   no numerical headroom. Any future refinement to anchor convention,
 *   depth definition, or pool composition could tip it. Do not tighten
 *   the gate without re-running validation; do not treat 0.50 as "loose."
 *
